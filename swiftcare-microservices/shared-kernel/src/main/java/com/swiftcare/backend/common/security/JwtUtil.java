...
public class JwtUtil {
    ...
    public String generateToken(String email, String role, String tier) {
        return Jwts.builder()
                .subject(email)
                .claim("role", role)
                .claim("tier", tier == null ? "FREE" : tier)
                .issuedAt(new Date())
    ...
    public String extractTier(String token) { return parseClaims(token).get("tier", String.class); }
